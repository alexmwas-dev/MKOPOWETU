...
class _LoanHistoryPageState extends State<LoanHistoryPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildLoanRecordView() {
    ...
    if (loanProvider.loans.isEmpty) {
      return _buildEmptyState('No loan records found.', 'Apply for a loan to get started.');
    }
  ...
  Widget _buildPaymentRecordView() {
    ...
    return _buildEmptyState('No payment records yet.', 'Your successful payments will appear here.');
  }
